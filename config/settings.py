# config/settings.py
# ─────────────────────────────────────────────────────────────────
#  Configuration globale du bot — chargée depuis .env
#  Toutes les valeurs sont validées par Pydantic au démarrage
# ─────────────────────────────────────────────────────────────────
...
class Settings(BaseSettings):
    ...
    PRIMARY_TF: str = "4h"       # Direction
    CONFIRM_TF: str = "1h"       # Confirmation
    ENTRY_TF: str = "15min"      # Setup entrée
    TRIGGER_TF: str = "5min"     # Déclencheur précis
    ...
    # ── FILTRES SESSIONS ──────────────────────────────────────────
    # Heures UTC des sessions haute probabilité
    ...
    TP1_RATIO: float = 1.0       # 1:1
    TP2_RATIO: float = 1.618     # Fibonacci
    TP3_RATIO: float = 2.5       # Fallback si pas d'OB/résistance
